window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function overlayElements() {
      ...
      root.style.cssText = "position:fixed;inset:0;pointer-events:none;z-index:900;opacity:0;transition:opacity .3s ease;visibility:hidden;";
      ...
      cring.style.cssText = "position:fixed;pointer-events:none;box-sizing:border-box;visibility:hidden;z-index:900;";
    ...
    function ensureStyleEl() {
      ...
      style.textContent = [
        ...
        "#dsh-pv-badge{position:fixed;right:18px;bottom:18px;display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:5px 12px;font-size:12px;font-weight:600;line-height:1.5;box-shadow:0 2px 12px rgba(0,0,0,.25);backdrop-filter:blur(6px);z-index:900;visibility:hidden}",
