  ...
  factory: (require) => {
    ...
    function ensureStyleEl() {
      ...
      style.textContent = [
        ...
        "[data-dsh-pv]{border:var(--dsh-pv-bw,2px) solid var(--dsh-pv-color,#f97316)!important;box-shadow:var(--dsh-pv-shadow,none)!important}",
    ...
    function applyOverlay(s, isPreview) {
      ...
      try {
        ...
        els.root.style.setProperty("--dsh-pv-glow-color", hexToRgba(color, opacity));
