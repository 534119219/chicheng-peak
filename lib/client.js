window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function PeakValleySection(props) {
      ...
      var composerPreview = createElement("div", { style: { display: "flex", flexDirection: "column", gap: "6px", flex: "none" } },
        createElement("span", { style: { fontSize: 12, color: "var(--dsw-alias-label-tertiary)" } }, t("preview")),
        createElement("div", {
          style: {
            width: 180, height: 44, borderRadius: 12, boxSizing: "border-box",
